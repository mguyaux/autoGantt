...
class ProjectResourceIT {
    ...
    private static final Integer DEFAULT_FTE_COUNT = 1;
    private static final Integer UPDATED_FTE_COUNT = 2;
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().name(DEFAULT_NAME).fteCount(DEFAULT_FTE_COUNT).startDate(DEFAULT_START_DATE);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().name(UPDATED_NAME).fteCount(UPDATED_FTE_COUNT).startDate(UPDATED_START_DATE);
        return project;
    }
    ...
    void createProject() throws Exception {
        ...
        assertThat(testProject.getFteCount()).isEqualTo(DEFAULT_FTE_COUNT);
    ...
    @Test
    @Transactional
    void checkFteCountIsRequired() throws Exception {
        int databaseSizeBeforeTest = projectRepository.findAll().size();
        // set the field null
        project.setFteCount(null);
    ...
    void getAllProjects() throws Exception {
        ...
        restProjectMockMvc
            ...
            .andExpect(jsonPath("$.[*].fteCount").value(hasItem(DEFAULT_FTE_COUNT)))
    ...
    void getProject() throws Exception {
        ...
        restProjectMockMvc
            ...
            .andExpect(jsonPath("$.fteCount").value(DEFAULT_FTE_COUNT))
    ...
    void putExistingProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).fteCount(UPDATED_FTE_COUNT).startDate(UPDATED_START_DATE);
        ...
        assertThat(testProject.getFteCount()).isEqualTo(UPDATED_FTE_COUNT);
    ...
    void fullUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).fteCount(UPDATED_FTE_COUNT).startDate(UPDATED_START_DATE);
