...
export class TaskUpdateComponent implements OnInit {
  ...
  protected updateForm(task: ITask): void {
    ...
    this.tasksSharedCollection = this.taskService.addTaskToCollectionIfMissing<ITask>(this.tasksSharedCollection, ...(task.requires ?? []));
  }
  ...
  protected loadRelationshipsOptions(): void {
    ...
    this.taskService
      ...
      .pipe(map((tasks: ITask[]) => this.taskService.addTaskToCollectionIfMissing<ITask>(tasks, ...(this.task?.requires ?? []))))
